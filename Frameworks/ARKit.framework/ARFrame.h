...
@property (nonatomic, retain) ARWorldTrackingErrorData *trackingErrorData;
...
- (id)faceData;
- (id)featurePoints;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })gravityAlignmentTransform;
