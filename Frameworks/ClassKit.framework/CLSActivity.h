...
@property (nonatomic, readonly) NSArray *_activityItems;
@property (nonatomic, copy) NSString *_primaryActivityItemIdentifier;
...
- (id)_primaryActivityItemIdentifier;
...
- (void)set_primaryActivityItemIdentifier:(id)arg1;
- (void)start;
- (void)stop;
